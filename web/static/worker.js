const base = "/web/static";
importScripts("https://cdn.jsdelivr.net/npm/xterm-pty@0.9.4/workerTools.js");
importScripts(location.origin + base  + "/browser_wasi_shim/index.js");
importScripts(location.origin + base  + "/browser_wasi_shim/wasi_defs.js");
importScripts(location.origin + base  + "/worker-util.js");
importScripts(location.origin + base  + "/wasi-util.js");
